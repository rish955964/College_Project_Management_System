...
echo htmlentities($msg);
                ...
                <div class="login-wrap">
                    <input type="text" class="form-control" name="username1" placeholder="College ID Number" required
                        autofocus autocomplete="off">
                    <br>
                    <input type="text" class="form-control" name="username" placeholder="Enrollment Number" required
                        autofocus autocomplete="off">
                    <br>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="email" name="email" placeholder="Email" autocomplete="off" class="form-control"
                                required><br>
                            <input type="text" name="contact" placeholder="contact No" autocomautoplete="off"
