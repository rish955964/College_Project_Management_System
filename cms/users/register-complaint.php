...
while ($rw=mysqli_fetch_array($sql)) {
  ?>
                                            ...
                                            <option value="<?php echo htmlentities($rw['id']);?>">
                                                <?php echo htmlentities($rw['category']);?></option>
                                            <?php
}
?>
                                        </select>
...
while ($rw=mysqli_fetch_array($sql)) {
  ?>
                                            <option value="<?php echo htmlentities($rw['lname']);?>">
                                                <?php echo htmlentities($rw['lname']);?></option>
                                            <?php
}
?>
...
document.getElementbyId('dept').value = clg;
                                    ...
                                    <div style="padding-left: 14px;">
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Complaint Details (max 2000
                                                words) </label>
                                            <div class="col-sm-6">
