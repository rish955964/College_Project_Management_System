...
echo htmlentities($msg);
                ...
                <div class="login-wrap">
                    <input type="text" class="form-control" placeholder="COLLEGE ID" id="fullname" name="fullname"
                        required="required" autocomplete="off" autocomplete="off">
                    <br>
                    <input type="text" class="form-control" placeholder="ENROLMENT NUMBER" id="email"
                        onBlur="userAvailability()" name="email" required="required" autocomplete="off">
                    ...
                    <input type="password" class="form-control" placeholder="Password" required="required"
                        ...
                        required>
                    <br>
                    <input type="tel" class="form-control" onLoad="GFG_FUN()" minlength="10" maxlength="10"
                        name="contactNo" placeholder="Contact no" required="required" autocomplete="off">
                    <br>
